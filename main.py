...
from scrape_data import get_used_car_intermediate_data
...
if __name__ == "__main__":
	...
	"""
	filename = "./output/car_dekho_intermediate_v1.csv"
	...
	pd.DataFrame(ch).to_csv("./output/cardekho_complete_data.csv")